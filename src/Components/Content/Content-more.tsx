  ...
  const style={
    ...
    return (
      <div className="flex justify-evenly ">
        ...
        <button className="bg-teal-600 text-white ml- w-full h-8 mt-6 rounded-b-lg hover:bg-teal-700">More info</button>
        </div>
        ...
        <button className="bg-green-700 text-white ml- w-full h-8 mt-9 rounded-b-lg hover:bg-green-800">More info</button>
        </div>
