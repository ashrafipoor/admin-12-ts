function Content_visitors() {
    ...
    return (
        <div  className="bg-blue-700 w-2/5 h-4/6  ml-auto mr-5 rounded-md border -mt-80 border-gray-300 flex">
         <h1 className="font-semibold text-lg ml-12 mt-3 h-8 text-white">Visitors</h1>
         <button className="bg-blue-600 text-white w-8 h-8 rounded-md ml-64 mt-2  hover:bg-blue-800"></button>
